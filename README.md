...
Please see the following link for a syllabus and information about key dates, homework, and the course project. [[Syllabus 2026]()]. Note that this is a lecture course with two homework assignments and a course project. 
...
**Please choose one paper to do this for, and turn them in to natalies@cs.unc.edu**. 
